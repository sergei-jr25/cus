    ...
    (() => {
        ...
        const checkScroll = () => {
            boxes.forEach(((box, index) => {
                ...
                if (boxPosition < screenHeight * .8) box.classList.add("_scroll-active"); else box.classList.remove("_scroll-active");
            }));
        };
        ...
        window.addEventListener("load", (function() {
            ...
            var content = document.querySelector('div[style="display:none;"]');
            loader.style.display = "none";
            content.style.display = "flex";
        }));
        const modules_flsModules = {};
        var smooth_scroll_polyfills_min = __webpack_require__(2);
        const gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
        ...
        const initSliders = () => {
            bildSliders();
            if (document.querySelector(".hero-page__slider")) new core(".hero-page__slider", {
                ...
                on: {
                    breakpoint: function(swiper, info) {
                        !info.autoHeight ? document.querySelector(".hero-page__swiper").style.height = "auto" : " ";
                    }
                }
            });
            if (document.querySelector(".gallery-page__slider")) {
                ...
                function resizeSlider() {
                    let diff = (window.innerWidth - document.querySelector(".gallery-page__container").offsetWidth) / 2;
                    if (diff > 0) document.querySelector(".gallery-page__slider").style.width = diff + document.querySelector(".gallery-page__slider").offsetWidth + 15 + "px"; else document.querySelector(".gallery-page__slider").style.width = document.querySelector(".gallery-page__slider").offsetWidth + 15 + "px";
                    console.log(innerWidth >= 991.98);
                    gallerySlider.update();
                }
                resizeSlider();
                window.addEventListener("resize", resizeSlider);
            }
            if (document.querySelector(".hero-pageBar__slider")) {
                new core(".hero-pageBar__slider", {
        ...
        document.addEventListener("DOMContentLoaded", (e => {
            ...
            const videoMedia = document.querySelector(".video__video");
            const videoPlay = document.querySelector(".video__play");
            document.addEventListener("click", (e => {
                if (e.target.closest(".video__video") || e.target.closest(".video__play")) if (!videoMedia.classList.contains("_hold")) {
                    videoMedia.play();
                    videoPlay.classList.add("_active");
                    videoMedia.classList.add("_hold");
                } else {
                    videoMedia.pause();
                    videoPlay.classList.remove("_active");
                    videoMedia.classList.remove("_hold");
                }
            }));
        }));
        window["FLS"] = true;
