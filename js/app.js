        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery-page__slider")) {
                ...
                function resizeSlider() {
                    ...
                    if (diff > 0) document.querySelector(".gallery-page__body").style.width = diff + document.querySelector(".gallery-page__body").offsetWidth + 15 + "px"; else document.querySelector(".gallery-page__body").style.width = document.querySelector(".gallery-page__body").offsetWidth + 15 + "px";
                }
                resizeSlider();
